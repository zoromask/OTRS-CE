...
sub Data {
    ...
    $Self->{Completeness}        = 0.163926089167656;
    ...
    $Self->{Translation} = {
        ...
        'invalid' => 'nederīgs',
        'valid' => 'derīgs',
        'No (not supported)' => 'Nē (neatbalsta)',
        ...
        'Disk Partitions Usage' => 'Diska nodalījumu lietojums',
        ...
        'Could not determine kernel version.' => 'Nevarēja noteikt kodola versiju.',
        ...
        'Config Settings' => 'Konfig. iestatījumi',
        ...
        'Webserver' => '',
        'Loaded Apache Modules' => 'Ielādētie Apache moduļi',
